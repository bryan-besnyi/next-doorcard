...
export default function ResumeDoorcard({ draft, onDelete }: ResumeDoorCardProps) {
  ...
  return (
    <Card className="flex flex-col">
      <CardContent className="flex-grow p-6">
        ...
        <p className="text-sm text-gray-500 mb-4">Last updated: {formatDate(draft.lastUpdated)}</p>
